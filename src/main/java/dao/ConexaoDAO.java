...
public class ConexaoDAO {
    ...
    /**
     * Instância de conexão estática para garantir uma única conexão.
     *
     * @return
     */
    /**
    ...
    public static Connection getConexao() {
        ...
        if (connection == null) {
            try {
                ...
                /**
                 * Servidor onde o banco de dados está hospedado.
                 */
                ...
                if (connection != null) {
                    ...
                    /**
                     * Imprime mensagem indicando conexão bem-sucedida.
                     */
                } else {
                    System.out.println("Status: Não Conectado!");
                    /**
                     * Imprime mensagem indicando falha na conexão.
                     */
                }
                return connection;
                /**
                ...
                /**
                 * Imprime mensagem de erro se o driver não for encontrado.
                 */
                return null;
