...
import dao.AmigoDAO; // Importa a classe AmigoDAO do pacote dao
import java.util.ArrayList; // Importa a classe ArrayList do pacote java.util

public class Amigo {

    private int id; // Variável para armazenar o ID do amigo
    private String nome, telefone; // Variáveis para armazenar o nome e o telefone do amigo
    private AmigoDAO dao; // Variável para acessar os métodos da classe AmigoDAO

    // Construtor padrão da classe Amigo
    public Amigo() {
        this(0, "", ""); // Chama o construtor sobrecarregado passando valores padrão
    }
    ...
    public Amigo(int id, String nome, String telefone) {
        ...
        dao = new AmigoDAO(); // Inicializa o objeto AmigoDAO para interagir com o banco de dados
    }
    ...
    public boolean inserirAmigo(String nome, String telefone) {
        ...
        dao.inserirAmigoBD(objeto); // Insere o amigo no banco de dados
    ...
    public boolean apagarAmigo(int id) {
        dao.apagarAmigoBD(id); // Apaga o amigo do banco de dados
    ...
    public boolean alterarAmigo(int id, String nome, String telefone) {
        Amigo objeto = new Amigo(id, nome, telefone); // Cria um novo objeto Amigo com os dados atualizados
        dao.alterarAmigoBD(objeto); // Altera os dados do amigo no banco de dados
    ...
    public Amigo carregarAmigo(int id) {
        return dao.carregarAmigoBD(id); // Carrega os dados do amigo do banco de dados e retorna o objeto Amigo correspondente
    }
